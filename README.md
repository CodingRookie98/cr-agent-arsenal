...
| **`dual-round-review`** | [`skills/dual-round-review`](./skills/dual-round-review) | **对抗性非讨好型双轮代码终审硬门禁**。<br/>第一轮红队第一性原理极限穿透 + 第二轮资深元架构师审判校准，彻底终结浅层创可贴补丁与大模型讨好型盲目交付；支持 Full / Light / Delta 三模式、审查记录锚点与条件维度。 | 具备子智能体派发能力的智能体 / CLI |
